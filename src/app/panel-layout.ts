    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">CommoHedge Monitor</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">COMMOHEDGE MONITOR</span>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} CommoHedge Monitor</span>
      </footer>
    `;
